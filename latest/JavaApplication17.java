...
public class JavaApplication17 {
    ...
    public void CreateParseTable() {
        ...
        try {
            br = new BufferedReader(new FileReader("Parse.csv"));
    ...
    public void Run_lex() {
        ...
        stack.push("0");
        try {
            BufferedReader br = new BufferedReader(new FileReader("parsefile.c"));
            String line;
    ...
    public void Run_Parser(String input, String lexeme) {
        ...
        String[] production = {"S->AS", "S->IS", "S->A", "S->I", "A->id=E;", "I->while(C){S}", "C->id relop id", "E->E+T", "E->E-T", "E->T", "T->T*F", "T->T/F", "T->F", "F->(E)", "F->id"};
...
//            this is it
            System.out.print("value stack content: " + valstack.subList(0, valstack.size()));
...
//            and now it's over
            ...
            if (val.equals("ACCEPT")) {
                System.out.println("Aaaaaaaand it's done!! :D");
                break;
            }
            if (val.charAt(0) == 'S') {
                //System.out.println("***************************");
...
//                valstack.push(symstack.peek());
    ...
    public static void main(String[] args) {
        ...
        JavaApplication17 ja17 = new JavaApplication17();
        ja17.CreateParseTable();
        ja17.Run_lex();
    }
